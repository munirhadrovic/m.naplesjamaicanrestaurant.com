<?php
	$adresa="4961 Rattlesnake Hammock Road Naples, Fl 34113"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2396873434;// Broj koji se poziva na dugme CALL US
